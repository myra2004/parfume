...
class RtfFormatter(Formatter):
    ...
    `fontsize`
        SizeCRUD of the font used. SizeCRUD is specified in half points. The
    ...
    `lineno_fontsize`
        Font size for line numbers. SizeCRUD is specified in half points
        (default: `fontsize`). 
    ...
    `lineno_color`
        ColorCRUD for line numbers specified as a hex triplet, e.g. ``'5e5e5e'``.
    ...
    `hl_color`
        ColorCRUD for highlighting the lines specified in `hl_lines`, specified as
